/* Image fallback: when an <img> fails to load (or completes with no
   pixel data), swap its src to a deterministic asset URL picked from a
   small list using a hash of the original src. Prevents broken images
   when remote assets are unreachable. */
(function () {
  var f = [
